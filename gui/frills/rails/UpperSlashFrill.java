/* Name: UpperSlashFrill.java
 *
 * What:
 *   This file defines a class for drawing Diagonal tracks on the Screen.
 *   The tracks run from the Top edge to the Left edge.
 */
 ...
 *   GridTile.  The tracks run from the Left edge to the Top edge.
...
public class UpperSlashFrill
    extends RailFrill {

  /**
   * constructs the UpperSlashfrill.
   */
  public UpperSlashFrill() {
    super(Sides.LEFT, Sides.TOP,
  ...
  public void setDOT(int dot) {
    super.setDOT(dot);
    if ( (Dot == Sides.LEFT) || (Dot == Sides.TOP)) {
      buildArrowHead(Dot);
    }
  }
